...
train_loader = DataLoader(
    splitted["train"], batch_size=BATCH_SIZE, shuffle=True, num_workers= 20, persistent_workers = True
)

test_loader = DataLoader(
    splitted["test"], batch_size=BATCH_SIZE, shuffle=False, num_workers=20, persistent_workers = True
)
